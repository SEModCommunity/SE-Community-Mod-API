...
namespace SEModAPI.API.Definitions
{
    ...
    public class VoxelMaterialDefinitionsWrapper : OverLayerDefinitionsManager<MyObjectBuilder_VoxelMaterialDefinition, VoxelMaterialsDefinition>
	{
		#region "Constructors and Initializers"

		public VoxelMaterialDefinitionsWrapper(MyObjectBuilder_VoxelMaterialDefinition[] definitions): base(definitions)
		{}
