...
namespace SEServerExtender
{
    public partial class SEServerExtender : Form
    {
        ...
        {
			string appdata = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData); //m_gameAssemblyWrapper.GetUserDataPath();
            MyConfigDedicatedData config = DedicatedConfigDefinition.Load(new FileInfo(appdata + @"\spaceengineersdedicated\SpaceEngineers-Dedicated.cfg"));
		...
		{
			string appdata = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData); //m_gameAssemblyWrapper.GetUserDataPath();
			m_dedicatedConfigDefinition.Save(new FileInfo(appdata + @"\spaceengineersdedicated\SpaceEngineers-Dedicated.cfg"));
		}
